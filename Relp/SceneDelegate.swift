    ...
    private func handleQuickAction(shortcutItem: UIApplicationShortcutItem) -> Bool {
        ...
        case .NewRestaurant:
            if let navController = tabBarController.viewControllers?[0] {
                let restaurantTableViewController = navController.children[0] //retrieve the restaurant table view controller from the tab bar controller
